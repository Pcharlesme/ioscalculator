...
class _CalculatorState extends State<Calculator> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Pcharles Calculator'),
        backgroundColor: Colors.black,
      ),
      body: Padding(
          ...
          children: <Widget>[
            ...
            Row(
              ...
              children: <Widget>[
                ...
                calcbutton('x', Color.fromARGB(255, 43, 0, 255), Colors.white),
              ],
            ),
            const SizedBox(
              height: 10,
            ...
            Row(
              ...
              children: <Widget>[
                ...
                calcbutton('+', Color.fromARGB(255, 43, 0, 255), Colors.white),
              ],
            ),
            SizedBox(
              height: 10,
